...
Blockchain zakat research has expanded steadily. Khan's decentralized platform [2] demonstrated that collection and distribution can function without intermediaries. Nazeri et al. [3] found that blockchain features align naturally with zakat management requirements in the Malaysian context. Khairi et al. [4] extended this work through a full ERC-20 token system with automated disbursement and a permanent audit trail. Nazeri et al. \cite{b_zakat_emerald} examined the potential and challenges more broadly. All of these systems share a common limitation. Every one of these systems records all transactional data on a publicly accessible ledger. Complete donor-recipient transparency, available to anyone running an Ethereum node. Fauzi et al. [19] confirmed through bibliometric analysis that research interest is climbing across Muslim-majority countries. Ascarya [20] showed that Islamic social finance instruments (zakat, infaq, sadaqah, waqf) supported economic recovery during the COVID-19 pandemic. Unal and Aysan [21] proposed blockchain as a harmonization tool for differing Sharia-compliance frameworks. Muharam and Osman \cite{b_isf_blockchain} explored the sustainability angle. None of these works integrate privacy-preserving transaction mechanisms.
...
The security analysis confirms that the protocol meets its design goals. The following section situates these results within the framework of Sharia compliance and deployment feasibility.
