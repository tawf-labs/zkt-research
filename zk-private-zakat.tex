...
15 contracts deployed via single forge script to Sepolia (chain ID 11155111). The ZKTCore (v7, 0xca849d...a7f7) routes \texttt{donateZK()} through \texttt{zakatEscrowManager.donate()} for pool accounting. An end-to-end donation (tx 0xdfaca7...eb9f, block 10,844,400) completed proof verification, nullifier registration, transfer, NFT minting, and event emission in 545K gas.
