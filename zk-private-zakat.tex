...
17 contracts deployed to Sepolia (chain ID 11155111). The ZKTCore (v6, 0x1da632...d35a) routes \texttt{donateZK()} through \texttt{zakatEscrowManager.donate()} for pool accounting. An end-to-end donation (tx 0xdfaca7...eb9f) completed verification, nullifier registration, transfer, NFT minting, and event emission in 545K gas.
