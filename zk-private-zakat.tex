...
BAZNAS [1] estimates Indonesia's annual zakat potential at Rp~327 trillion (approximately USD~20 billion), yet actual collection remains far lower. Blockchain-based zakat platforms have emerged to address operational gaps in collection and distribution. Khan [2] demonstrated that blockchain can support decentralized collection and distribution. Nazeri et al. [3] found that blockchain features such as transparency, traceability, and security align with Malaysian zakat management objectives. Khairi et al. [4] developed a system with automated disbursement and an immutable audit trail using ERC-20 tokens. These systems share a common limitation: full donor-recipient transaction records posted on public ledgers expose socioeconomic vulnerabilities, contradicting Islamic privacy norms.
