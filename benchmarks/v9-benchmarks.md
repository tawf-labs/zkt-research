...
| ACIR opcodes | 29 |
| Brillig opcodes | 44 |
| Proof generation (avg) | 240 ms (run log: 0.23, 0.24, 0.24, 0.25, 0.24s) |
| Proof verification (avg) | 11 ms (run log: 0.03, 0.01, 0.01, 0.01, 0.01s) |
...
### Deployer
- Account: zk-deployer
- Estimated total gas: 39,905,120
- Estimated ETH required: 0.0007296 ETH
